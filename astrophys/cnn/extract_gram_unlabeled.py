...
model_path = Path('/storage/home/tommaria/thesis/new_gravityspy/model')
...
data_path = Path('/storage/home/tommaria/thesis/new_gravityspy/training')
...
data_path = Path('/storage/home/tommaria/thesis/new_gravityspy/training/gram')
...
for file in files:
	...
	print(vmem.total >> 20, vmem.available >> 20, vmem.used >> 20, vmem.free >> 20, vmem.percent)
